...
@section('content')
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <h3 class="text-sm font-medium text-gray-500">{{ $kpis['total_revenue']['label'] }}</h3>
                    </div>
                    <p class="text-3xl font-bold text-gray-900 mb-1">
                        {{ number_format($kpis['total_revenue']['value'], 0, ',', ' ') }} CFA
                    </p>
                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <h3 class="text-sm font-medium text-gray-500">{{ $kpis['month_revenue']['label'] }}</h3>
                    </div>
                    <p class="text-3xl font-bold text-gray-900 mb-1">
                        {{ number_format($kpis['month_revenue']['value'], 0, ',', ' ') }} CFA
                    </p>
                    <div class="flex items-center text-xs text-gray-600">
                        @if ($kpis['month_revenue']['growth']['trend'] === 'up')
                            ...
                            <span
                                class="text-green-600 font-medium">+{{ $kpis['month_revenue']['growth']['percentage'] }}%</span>
                            <span class="ml-1">vs mois dernier</span>
                        @elseif($kpis['month_revenue']['growth']['trend'] === 'down')
                            ...
                            <span
                                class="text-red-600 font-medium">{{ $kpis['month_revenue']['growth']['percentage'] }}%</span>
                            <span class="ml-1">vs mois dernier</span>
                        @else
                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <h3 class="text-sm font-medium text-gray-500">{{ $kpis['completed_orders']['label'] }}</h3>
                    </div>
                    <p class="text-3xl font-bold text-gray-900 mb-1">{{ number_format($kpis['completed_orders']['value']) }}
                    </p>
                    <div class="flex items-center text-xs text-gray-600">
                        <span>{{ $kpis['completed_orders']['month_value'] }} ce mois</span>
                        @if ($kpis['completed_orders']['growth']['percentage'] != 0)
                            <span
                                class="ml-2 px-2 py-0.5 {{ $kpis['completed_orders']['growth']['percentage'] > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }} rounded text-xs font-medium">
                                {{ $kpis['completed_orders']['growth']['percentage'] > 0 ? '+' : '' }}{{ $kpis['completed_orders']['growth']['percentage'] }}%
                            </span>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <h3 class="text-sm font-medium text-gray-500">{{ $kpis['average_order_value']['label'] }}</h3>
                    </div>
                    <p class="text-3xl font-bold text-gray-900 mb-1">
                        {{ number_format($kpis['average_order_value']['value'], 0, ',', ' ') }} CFA
                    </p>
                    <div class="flex items-center text-xs text-gray-600">
                        <span>{{ number_format($kpis['average_order_value']['month_value'], 0, ',', ' ') }} CFA ce
                            mois</span>
                        @if ($kpis['average_order_value']['growth']['percentage'] != 0)
                            <span
                                class="ml-2 px-2 py-0.5 {{ $kpis['average_order_value']['growth']['percentage'] > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }} rounded text-xs font-medium">
                                {{ $kpis['average_order_value']['growth']['percentage'] > 0 ? '+' : '' }}{{ $kpis['average_order_value']['growth']['percentage'] }}%
                            </span>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <h3 class="text-sm font-medium text-gray-500">{{ $kpis['conversion_rate']['label'] }}</h3>
                    </div>
                    <p class="text-3xl font-bold text-gray-900 mb-1">
                        {{ number_format($kpis['conversion_rate']['value'], 1) }}%</p>
                    <div class="flex items-center text-xs text-gray-600">
                        <span>{{ number_format($kpis['conversion_rate']['month_value'], 1) }}% ce mois</span>
                        @if ($kpis['conversion_rate']['growth']['percentage'] != 0)
                            <span
                                class="ml-2 px-2 py-0.5 {{ $kpis['conversion_rate']['growth']['percentage'] > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }} rounded text-xs font-medium">
                                {{ $kpis['conversion_rate']['growth']['percentage'] > 0 ? '+' : '' }}{{ $kpis['conversion_rate']['growth']['percentage'] }}%
                            </span>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <h3 class="text-sm font-medium text-gray-500">{{ $kpis['total_customers']['label'] }}</h3>
                    </div>
                    <p class="text-3xl font-bold text-gray-900 mb-1">
                        {{ number_format($kpis['total_customers']['value']) }}</p>
                    <div class="flex items-center text-xs text-gray-600">
                        <span>{{ $kpis['total_customers']['month_value'] }} nouveaux ce mois</span>
                        @if ($kpis['total_customers']['growth']['percentage'] != 0)
                            <span
                                class="ml-2 px-2 py-0.5 {{ $kpis['total_customers']['growth']['percentage'] > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }} rounded text-xs font-medium">
                                {{ $kpis['total_customers']['growth']['percentage'] > 0 ? '+' : '' }}{{ $kpis['total_customers']['growth']['percentage'] }}%
                            </span>
                        @endif
                    </div>
                </div>
            ...
            <div class="mb-8 bg-white overflow-hidden shadow-lg sm:rounded-lg p-6 border-l-4 border-red-500">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <h3 class="text-sm font-medium text-gray-500 mb-2">{{ $kpis['customer_retention']['label'] }}</h3>
                        <p class="text-4xl font-bold text-gray-900">
                            {{ number_format($kpis['customer_retention']['value'], 1) }}%</p>
                        <p class="text-sm text-gray-600 mt-2">
                            {{ $kpis['customer_retention']['repeat_customers'] }} clients fidèles sur
                            {{ $kpis['total_customers']['value'] }} clients uniques
                        </p>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-semibold text-gray-900 mt-1">{{ $kpis['today_completed'] }}</p>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-semibold text-gray-900 mt-1">
                                {{ number_format($kpis['today_revenue'], 0, ',', ' ') }} CFA
                            </p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-semibold text-gray-900 mt-1">{{ $localStats['pending_orders'] }}</p>
                ...
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-2">
                            <button onclick="toggleChartType('sales')"
                                class="px-3 py-1 text-sm rounded-md bg-blue-100 text-blue-700 font-medium">
                                Ventes
                            </button>
                            <button onclick="toggleChartType('orders')"
                                class="px-3 py-1 text-sm rounded-md bg-gray-100 text-gray-700 font-medium">
                                Commandes
                            </button>
                        </div>
                    </div>
            ...
            {{-- <div class="mt-8 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-6">Top Créateurs</h3>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Par ventes -->
                        <div>
                            <h4 class="text-sm font-medium text-gray-700 mb-4">Par chiffre d'affaires</h4>
                            <div class="space-y-4">
                                @foreach ($enhancedStats['creator_stats']['top_creators_by_sales'] as $index => $creator)
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            <span class="text-lg font-bold text-gray-400 mr-3">#{{ $index + 1 }}</span>
                                            <div>
                                                <p class="font-medium text-gray-900">{{ $creator->name }}</p>
                                                <p class="text-xs text-gray-500">{{ $creator->brand_slug }}</p>
                                            </div>
                                        </div>
                                        <span
                                            class="font-semibold">{{ number_format($creator->total_sales ?? 0, 0, ',', ' ') }}
                                            CFA</span>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <!-- Par commandes -->
                        <div>
                            <h4 class="text-sm font-medium text-gray-700 mb-4">Par nombre de commandes</h4>
                            <div class="space-y-4">
                                @foreach ($enhancedStats['creator_stats']['creators_with_most_orders'] as $index => $creator)
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            <span class="text-lg font-bold text-gray-400 mr-3">#{{ $index + 1 }}</span>
                                            <div>
                                                <p class="font-medium text-gray-900">{{ $creator->name }}</p>
                                                <p class="text-xs text-gray-500">{{ $creator->status }}</p>
                                            </div>
                                        </div>
                                        <span class="font-semibold">{{ $creator->orders_count }} commandes</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <a href="{{ route('admin.creators') }}" class="text-blue-600 hover:text-blue-800 text-sm">
                                Voir tous →
                            </a>
                        </div>
                        @isset($recentCreators)
                            @if ($recentCreators->count() > 0)
                                <div class="space-y-4">
                                    @foreach ($recentCreators as $creator)
                                        <div
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    <p class="text-sm font-medium text-gray-900">{{ $creator->name }}</p>
                                            ...
                                            {{ $creator->status === 'active'
                                                ...
                                                : ($creator->status === 'inactive'
                                                    ...
                                                    {{ $creator->status === 'active' ? 'Actif' : ($creator->status === 'inactive' ? 'Inactif' : 'Suspendu') }}
                                                </span>
                                                <p class="text-xs text-gray-500 mt-1">{{ $creator->brand_slug }}</p>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <a href="{{ route('admin.reports.product-sales') }}"
                                class="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                                <div class="flex items-center">
                                    <div
            ...
            {{-- <div class="mt-8 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Synchronisation</h3>

                    <!-- Stats de synchronisation -->
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div class="bg-blue-50 p-4 rounded-lg">
                            <p class="text-sm text-blue-700">Dernière synchro</p>
                            <p class="text-lg font-semibold text-blue-900">
                                {{ $lastSync ? $lastSync->completed_at->diffForHumans() : 'Jamais' }}
                            </p>
                            @if ($lastSync)
                                <p class="text-xs text-blue-600 mt-1">
                                    {{ $lastSync->created_records ?? 0 }} créés,
                                    {{ $lastSync->updated_records ?? 0 }} mis à jour
                                </p>
                            @endif
                        </div>

                        <div class="bg-green-50 p-4 rounded-lg">
                            <p class="text-sm text-green-700">Commandes locales</p>
                            <p class="text-lg font-semibold text-green-900">
                                {{ number_format($localStats['local_order_count']) }}
                            </p>
                            <p class="text-xs text-green-600 mt-1">
                                {{ $localStats['today_orders'] }} aujourd'hui
                            </p>
                        </div>

                        <div class="bg-purple-50 p-4 rounded-lg">
                            <p class="text-sm text-purple-700">CA local</p>
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <button onclick="triggerSync('orders', true)"
                    ...
                    <div id="syncResult" class="mt-4 hidden"></div>

                    <!-- Progression -->
                    <div id="syncProgress" class="mt-4 hidden">
                        <div class="flex justify-between text-sm text-gray-600 mb-1">
                            <span>Synchronisation en cours...</span>
                            <span id="syncProgressPercent">0%</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div id="syncProgressBar" class="bg-blue-600 h-2 rounded-full" style="width: 0%"></div>
                        </div>
                    </div>
                    ...
                    @if ($recentLogs->count() > 0)
                        <div class="mt-6 pt-6 border-t border-gray-200">
                            <h4 class="text-sm font-medium text-gray-900 mb-3">Logs récents</h4>
                            <div class="space-y-2">
                                @foreach ($recentLogs as $log)
                                    <div class="flex items-center justify-between text-sm">
                                        <span class="text-gray-700">
                                            {{ $log->sync_type }} -
                                            <span
                                                class="font-medium {{ $log->status === 'success' ? 'text-green-600' : ($log->status === 'failed' ? 'text-red-600' : 'text-yellow-600') }}">
                                                {{ $log->status }}
                                            </span>
                                        </span>
                ...
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        {{ $apiConnected ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                            {{ $apiConnected ? 'Connecté' : 'Non connecté' }}
                        </span>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-700">
                                @if (config('services.wordpress.url'))
    ...
    `;
        ...
        function loadRecentOrders() {
            ...
            fetch('{{ route('admin.api.recent-orders') }}')
                .then(response => response.json())
                .then(data => {
...
<script>
    ...
    function initChart() {
        ...
        const data = @json($last7DaysStats);
