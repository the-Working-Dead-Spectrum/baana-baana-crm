        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <div class="flex items-center space-x-3">
                    <a href="{{ route('products.by-brand', $product->brand_slug) }}" 
                    ...
                    <div class="p-6">
                        ...
                        <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div class="border-b border-gray-200 pb-4">
                                ...
                                <dd class="mt-1 text-sm text-gray-900">{{ $product->wp_product_id }}</dd>
                            </div>
                            ...
                            <div class="border-b border-gray-200 pb-4">
                                ...
                                <dd class="mt-1 text-sm text-gray-900">{{ $product->sku ?? 'Non défini' }}</dd>
                            </div>
                            ...
                            <div class="border-b border-gray-200 pb-4">
                                ...
                                <dd class="mt-1">
                                    {{-- @php
                                        ...
                                        $stockClass = $stock <= 0 ? 'bg-red-100 text-red-800' : 
                            ...
                            <div class="border-b border-gray-200 pb-4">
                                ...
                                <dd class="mt-1 text-lg font-semibold text-gray-900">
                                    {{ number_format(($product->price ?? 0) * ($product->stock_quantity ?? 0), 0, ',', ' ') }} CFA
                                </dd>
                            </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">
                                            {{ number_format($sale->unit_price ?? 0, 0, ',', ' ') }} CFA
                                        </td>
                                        <td class="px-4 py-3 whitespace-nowrap text-sm font-semibold text-gray-900">
                                            {{ number_format($sale->total ?? 0, 0, ',', ' ') }} CFA
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div class="space-y-4">
                            <div class="bg-blue-50 p-4 rounded-lg">
                                ...
                                <p class="text-2xl font-bold text-blue-900">
                                    {{ number_format($salesStats->total_quantity ?? 0, 0, ',', ' ') }}
                                </p>
                            ...
                            <div class="bg-blue-50 p-4 rounded-lg">
                                ...
                                <p class="text-2xl font-bold text-blue-900">
                                    {{ number_format($orderClosed->completed_quantity  ?? 0, 0, ',', ' ') }}
                                </p>
                                <p class="text-xs text-blue-600 mt-1">unités</p>
                            </div>
                            ...
                            <div class="bg-green-50 p-4 rounded-lg">
                                ...
                                <p class="text-2xl font-bold text-green-900">
                                    {{ number_format($orderClosed->completed_sales ?? 0, 0, ',', ' ') }}
                                </p>
                            ...
                            <div class="bg-purple-50 p-4 rounded-lg">
                                ...
                                <p class="text-2xl font-bold text-purple-900">
                                    {{ number_format($salesStats->order_count ?? 0, 0, ',', ' ') }}
                                </p>
                            ...
                            <div class="bg-orange-50 p-4 rounded-lg">
                                ...
                                <p class="text-2xl font-bold text-orange-900">
                                    {{ number_format($salesStats->average_price ?? 0, 0, ',', ' ') }}
                                </p>
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-gray-200">
                                ...
                                <span class="text-sm font-medium {{ $stock > 20 ? 'text-green-600' : ($stock > 0 ? 'text-yellow-600' : 'text-red-600') }}">
                                    {{ $stock > 20 ? 'En stock' : ($stock > 0 ? 'Stock faible' : 'Rupture') }}
                                </span>
                            </div>
                            ...
                            @if($stockDays !== null && $totalSales > 0)
                            <div class="flex justify-between items-center py-2 border-b border-gray-200">
                                <span class="text-sm text-gray-600">Jours de stock restants</span>
                                <span class="text-sm font-medium {{ $stockDays < 7 ? 'text-red-600' : ($stockDays < 30 ? 'text-yellow-600' : 'text-green-600') }}">
                                    ~{{ $stockDays }} jours
                                </span>
                            </div>
                            @endif
                            ...
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="text-sm font-medium {{ $totalSales > 50 ? 'text-green-600' : ($totalSales > 10 ? 'text-blue-600' : 'text-gray-600') }}">
                                    {{ $totalSales > 50 ? 'Excellent' : ($totalSales > 10 ? 'Bon' : 'Faible') }}
                                </span>
                            </div>
                        </div>
                    </div>
