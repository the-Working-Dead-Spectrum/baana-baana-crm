                    ...
                    <div class="bg-white rounded-lg shadow p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $roleStats['admin'] ?? 0 }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $roleStats['creator'] ?? 0 }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $roleStats['logistic'] ?? 0 }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $roleStats['user'] ?? 0 }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <select name="role" id="role"
                                    ...
                                    @foreach ($availableRoles as $roleOption)
                                        <option value="{{ $roleOption }}"
                                            {{ request('role') == $roleOption ? 'selected' : '' }}>
                                            {{ ucfirst($roleOption) }}
                                        </option>
                                    @endforeach
                                </select>
