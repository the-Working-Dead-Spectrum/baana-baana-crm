...
<?php $__env->startSection('header', 'Créer un nouvel utilisateur'); ?>
...
<div class="py-6">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <form action="<?php echo e(route('admin.users.store')); ?>" method="POST" class="px-4 py-5 sm:p-6">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <select id="role" 
                                    ...
                                    <?php $__currentLoopData = $availableRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roleOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($roleOption); ?>" <?php echo e(old('role') == $roleOption ? 'selected' : ''); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wp-cs-crm\resources\views/admin/users/create.blade.php ENDPATH**/ ?>