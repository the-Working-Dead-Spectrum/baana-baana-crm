...
<?php $__env->startSection('title', 'Produits - ' . $brandSlug); ?>
...
<div class="py-8">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900"><?php echo e($brandSlug); ?></h1>
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-semibold text-gray-900">
                                    <?php echo e($brandStats->product_count ?? 0); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-semibold text-gray-900">
                                    <?php echo e(number_format($brandStats->average_price ?? 0, 0, ',', ' ')); ?> CFA
                                </dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-semibold text-gray-900">
                                    <?php echo e(number_format($salesStats->total_sales ?? 0, 0, ',', ' ')); ?> CFA
                                </dd>
                                <dd class="text-xs text-gray-500 mt-1">
                                    <?php echo e(number_format($salesStats->total_quantity ?? 0, 0, ',', ' ')); ?> unités vendues
                                </dd>
                            </dl>
                        </div>
                    </div>
        ...
        <!-- Top produits vendus -->
        <?php if($topProducts && $topProducts->count() > 0): ?>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center justify-center h-8 w-8 rounded-full <?php echo e($index === 0 ? 'bg-yellow-100 text-yellow-800' : ($index === 1 ? 'bg-gray-100 text-gray-800' : 'bg-orange-100 text-orange-800')); ?> font-semibold">
                                        <?php echo e($index + 1); ?>
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-xs text-gray-500">
                                        ID: <?php echo e($product->wp_product_id); ?>

                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                                        <?php echo e(number_format($product->total_quantity, 0, ',', ' ')); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($product->order_count); ?> commande(s)
                                </td>
                            </tr>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-xl font-semibold text-gray-900">Tous les produits (<?php echo e($products->total()); ?>)</h2>
                        ...
                        <table class="min-w-full divide-y divide-gray-200" id="productsTable">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <tr class="hover:bg-gray-50" data-stock-status="<?php echo e($stockStatus); ?>">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                <div>
                                                    <div class="text-sm font-medium text-gray-900">
                                                    ...
                                                    <div class="text-xs text-gray-500">
                                                        ID WP: <?php echo e($product->wp_product_id); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($stockClass); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wp-cs-crm\resources\views/admin/products/by-brand.blade.php ENDPATH**/ ?>