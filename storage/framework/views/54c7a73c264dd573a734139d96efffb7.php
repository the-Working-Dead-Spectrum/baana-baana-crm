...
<?php $__env->startSection('title', 'Fiche Client - ' . ($customer->customer_name ?? 'Client inconnu')); ?>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white shadow-sm rounded-lg p-6">
                    <div class="flex flex-col items-center text-center mb-6">
                        ...
                        <?php if($customer->customer_email): ?>
                            <p class="text-sm text-gray-600 mt-1"><?php echo e($customer->customer_email); ?></p>
                        <?php endif; ?>
                        ...
                        <div class="space-y-3">
                            <?php if($customer->customer_email): ?>
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <a href="mailto:<?php echo e($customer->customer_email); ?>" 
                                           class="text-blue-600 hover:underline font-medium">
                                            <?php echo e($customer->customer_email); ?>
                            ...
                            <?php if($customer->customer_phone): ?>
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <a href="tel:<?php echo e($customer->customer_phone); ?>" 
                                           class="text-blue-600 hover:underline font-medium">
                                            <?php echo e($customer->customer_phone); ?>
                            ...
                            <?php if($customer->last_shipping_address): ?>
                                <div class="flex items-start">
                                    <svg class="w-5 h-5 text-gray-400 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        <p class="text-sm text-gray-700"><?php echo e($customer->last_shipping_address); ?></p>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="text-center p-3 bg-blue-50 rounded-lg">
                                <div class="text-2xl font-bold text-blue-700"><?php echo e($customer->order_count); ?></div>
                                <div class="text-xs text-blue-600 mt-1">Commandes</div>
                            </div>
                            
                            <div class="text-center p-3 bg-green-50 rounded-lg">
                                <div class="text-2xl font-bold text-green-700"><?php echo e(number_format($customer->total_spent, 0, ',', ' ')); ?> FCFA</div>
                                <div class="text-xs text-green-600 mt-1">Total dépensé</div>
                            </div>
                            
                            <div class="text-center p-3 bg-purple-50 rounded-lg">
                                <div class="text-2xl font-bold text-purple-700"><?php echo e(number_format($customer->average_order, 0, ',', ' ')); ?> FCFA</div>
                ...
                <?php if(count($customer->favorite_brands) > 0): ?>
                    <div class="bg-white shadow-sm rounded-lg p-6">
                        <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">Marques favorites</h3>
                        
                        <div class="space-y-2">
                            <?php $__currentLoopData = $customer->favorite_brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-gray-700"><?php echo e($brand); ?></span>
                                    <span class="text-xs px-2 py-1 bg-gray-100 text-gray-700 rounded-full">
                                        <?php echo e($count); ?> <?php echo e($count > 1 ? 'commandes' : 'commande'); ?>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white shadow-sm rounded-lg p-6">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <span class="text-sm text-gray-500"><?php echo e($customer->orders->total()); ?> commande(s) trouvée(s)</span>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-2 mb-6">
                        <button onclick="filterOrders('all')" 
                            ...
                            Toutes (<?php echo e($customer->order_count); ?>)
                        </button>
                        <button onclick="filterOrders('completed')" 
                            ...
                            Terminées (<?php echo e($customer->completed_orders_count); ?>)
                        </button>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $customer->orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white shadow-sm rounded-lg overflow-hidden hover:shadow-md transition-shadow duration-200">
                        ...
                        <div class="p-6">
                            <div class="mb-4">
                                <h4 class="text-sm font-medium text-gray-900 mb-2">Articles (<?php echo e($order->items->count()); ?>)</h4>
                                <div class="space-y-2">
                                    <?php $__currentLoopData = $order->items->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center justify-between text-sm">
                                            <div class="flex items-center">
                                                ...
                                                <span class="text-gray-700 truncate"><?php echo e($item->product_name); ?></span>
                                            </div>
                                            <div class="text-gray-900 font-medium">
                                                <?php echo e($item->quantity); ?> × <?php echo e(number_format($item->unit_price, 0, ',', ' ')); ?> FCFA
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if($order->items->count() > 3): ?>
                                        <div class="text-center pt-2">
                                            <span class="text-xs text-gray-500">
                                                +<?php echo e($order->items->count() - 3); ?> autre(s) article(s)
                                            </span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-gray-200">
                                <div>
                                    ...
                                    <div class="text-sm font-medium <?php echo e($order->payment_status === 'paid' ? 'text-green-600' : 'text-yellow-600'); ?>">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm font-medium">
                                        <?php echo e(ucfirst($order->logistics_status ?? 'En préparation')); ?>
                                ...
                                <div>
                                    ...
                                    <?php if($order->tracking_number): ?>
                                        <div class="text-sm font-medium text-blue-600"><?php echo e($order->tracking_number); ?></div>
                                    <?php else: ?>
                                ...
                                <div>
                                    ...
                                    <div class="text-sm font-medium">
                                        <?php echo e($order->creators->count()); ?> créateur(s)
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="px-6 py-3 bg-gray-50 border-t border-gray-200">
                            <div class="flex justify-between">
                                ...
                                <?php if($order->status === 'processing'): ?>
                                    <button onclick="markAsShipped(<?php echo e($order->id); ?>)" 
                ...
                <?php if($customer->orders->hasPages()): ?>
                    <div class="bg-white shadow-sm rounded-lg p-6">
                        <div class="flex justify-center">
                            <?php echo e($customer->orders->links()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wp-cs-crm\resources\views/admin/customers/show.blade.php ENDPATH**/ ?>