...
<head>
    ...
    <title><?php echo e(config('app.name', 'BAANA BAANA BOUTIQUE')); ?></title>
            ...
            <div class="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-white shadow lg:hidden">
                ...
                <div class="flex-1 flex justify-between px-4">
                    <div class="flex-1 flex items-center">
                        <a href="<?php echo e(route($dashboardRoute)); ?>" class="ml-4">
                            <?php if (isset($component)) { $__componentOriginal8892e718f3d0d7a916180885c6f012e7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8892e718f3d0d7a916180885c6f012e7 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'block h-8 w-auto fill-current text-gray-800']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'block h-8 w-auto fill-current text-gray-800']); ?>
            ...
            <main class="flex-1">
                <div class="py-6">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <?php if(isset($header)): ?>
                            <div class="mb-8">
                                <h1 class="text-2xl font-bold text-gray-900"><?php echo e($header); ?></h1>
                            </div>
                        <?php endif; ?>
...
<?php /**PATH C:\laragon\www\wp-cs-crm\resources\views/layouts/app.blade.php ENDPATH**/ ?>