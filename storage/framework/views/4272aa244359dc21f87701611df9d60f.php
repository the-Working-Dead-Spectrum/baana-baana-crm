...
<?php $__env->startSection('title', 'Paramètres de Synchronisation'); ?>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="border-b border-gray-200 pb-4">
                                <div class="flex justify-between items-start">
                                    ...
                                    <div class="text-right">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium 
                                            <?php echo e(!empty($wordpressUrl) ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                            <?php echo e(!empty($wordpressUrl) ? 'Configurée' : 'Non configurée'); ?>
                                ...
                                <div class="mt-2">
                                    <code class="text-sm bg-gray-100 px-3 py-2 rounded-md text-gray-800 block overflow-x-auto">
                                        <?php echo e($wordpressUrl ?? 'Non définie'); ?>
                            ...
                            <div class="border-b border-gray-200 pb-4">
                                <div class="flex justify-between items-start">
                                    ...
                                    <div class="text-right">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium 
                                            <?php echo e($webhookConfigured ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                            <?php echo e($webhookConfigured ? 'Configuré' : 'À configurer'); ?>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <span class="text-xs text-gray-500"><?php echo e($syncLogs->count()); ?> logs</span>
                        </div>
                        
                        <?php if($syncLogs->count() > 0): ?>
                            <div class="space-y-4">
                                <?php $__currentLoopData = $syncLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="border-l-4 <?php echo e($log->status === 'success' ? 'border-green-500 bg-green-50' : 'border-red-500 bg-red-50'); ?> pl-4 py-3">
                                        <div class="flex justify-between items-start">
                                            <div>
                                            ...
                                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium 
                                                ...
                                                <?php echo e($log->status === 'success' ? 'Succès' : 'Erreur'); ?>

                                            </span>
                                        </div>
                                        <?php if($log->details): ?>
                                            <p class="text-sm text-gray-600 mt-2">
                                                <?php echo e(Str::limit($log->details, 60)); ?>

                                            </p>
                                        <?php endif; ?>
                                        <?php if($log->record_count): ?>
                                            <p class="text-xs text-gray-500 mt-1">
                                                <?php echo e($log->record_count); ?> enregistrement(s)
                                            </p>
                                        <?php endif; ?>
                                    </div>
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between">
                                ...
                                <span class="text-sm font-medium text-gray-900">
                                    <?php echo e($syncLogs->first() ? $syncLogs->first()->created_at->diffForHumans() : 'Jamais'); ?>

                                </span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-sm text-gray-600">Environnement :</span>
                                <span class="text-sm font-medium text-gray-900"><?php echo e(app()->environment()); ?></span>
                            </div>
                            <div class="flex justify-between">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wp-cs-crm\resources\views/admin/settings.blade.php ENDPATH**/ ?>